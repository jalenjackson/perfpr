Meteor.startup(function(){
    ...
    local.init = function()
    {
        ...
        document.getElementById("webgl").appendChild( local.container );
        ...
        local.scene.fog = new THREE.FogExp2( 0xff0000, 0.0006 );
    ...
    local.generateLineGeometry = function(nodes, range) {
        ...
        for ( i = 0; i < nodes; i ++ ) {
            ...
            var tartheta = theta + 10*Math.PI/180;//Math.random()*2*Math.PI;
            var tarphi = phi + 10*Math.PI/180;////Math.random()*Math.PI;
