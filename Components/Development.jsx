    ...
    render(){
        return(
            <div id="design-page">
                ...
                <div style={{height: "750px"}} className="development-header">
                    ...
                    <div style={{marginTop:"160px"}} className="pin-container development-pin-container">
                        ...
                        <div style={{animationDelay: "0.6s"}} className="pin move-pin">
                            <div className="design-img-div development-div-4">
                            </div>
                ...
                <div className="design-message design-message2">
